...
class SystemMonitorGUI(QWidget):
    ...
    def sys_status_callback(self, sys_status_sub):
        try:
            ...
            self.sys_status_data['CPU Usage'] = 'N/A'
            self.sys_status_data['CPU Freq'] = 'N/A'
            self.sys_status_data['GPU Usage'] = 'N/A'
            self.sys_status_data['Memory'] = 'N/A'
    ...
    def init_msgs_sync(self):
        self.sys_status_sub = rospy.Subscriber('/get_sys_status', Float32MultiArray, self.sys_status_callback)  # Total sys info
